...
class SchoolTest < Minitest::Test
  ...
  def test_it_can_add_total_time
    school1 = School.new('9:00', 7)
    school2 = School.new('9:00', 3)
    assert_equal 16, school1.total_time
    assert_equal 12, school2.total_time
  end
  ...
  def test_it_can_tell_if_is_full_time
    school = School.new('9:00', 7)
    assert school.is_full_time?
  end

  def test_it_can_tell_standard_student_names
    school = School.new('9:00', 7)
    school.add_student_name('Aurora')
    school.add_student_name('tim')
    school.add_student_name('megan')
  ...
  def test_it_can_convert_time_format
    school = School.new('9:00', 7)
